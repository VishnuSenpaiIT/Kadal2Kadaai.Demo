          ...
          <form onSubmit={form2.handleSubmit(onStep2Submit)} className="space-y-4">
            <div>
              ...
              <div className="relative mt-1">
                <Input type={showPassword ? "text" : "password"} {...form2.register('password')} className="pr-10" />
            ...
            <div>
              ...
              <div className="relative mt-1">
                <Input type={showConfirmPassword ? "text" : "password"} {...form2.register('password_confirmation')} className="pr-10" />
