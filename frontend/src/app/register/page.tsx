...
const step1Schema = z.object({
  ...
  pincode: z.string().regex(/^[1-9][0-9]{5}$/, 'Invalid Indian pincode format'),
...
export default function RegisterPage() {
  ...
  const form1 = useForm({
    ...
    defaultValues: { first_name: '', last_name: '', district: '', pincode: '', contact_number: '' }
  });
          ...
          <form onSubmit={form1.handleSubmit(onStep1Submit)} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input {...form1.register('pincode')} placeholder="600001" />
                {form1.formState.errors.pincode && <p className="text-xs text-destructive mt-1">{form1.formState.errors.pincode.message as string}</p>}
              </div>
            </div>
        ...
        {step === 2 && (
          <form onSubmit={form2.handleSubmit(onStep2Submit)} className="space-y-4">
            <div>
              ...
              <Input type="email" {...form2.register('email')} placeholder="john@example.com" />
              {form2.formState.errors.email && <p className="text-xs text-destructive mt-1">{form2.formState.errors.email.message as string}</p>}
            </div>
