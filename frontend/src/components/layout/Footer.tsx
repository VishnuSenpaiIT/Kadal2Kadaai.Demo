        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/products?category=fresh-fish" className="hover:text-primary transition-colors">Fresh Fish</Link></li>
              <li><Link href="/products?category=prawns" className="hover:text-primary transition-colors">Prawns & Crabs</Link></li>
