    ...
    >
      <Container className="flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3 group shrink-0">
          <div className="w-10 h-10 rounded-full border border-slate-200 bg-white p-0.5 shadow-sm transform group-hover:scale-105 transition-transform overflow-hidden flex items-center justify-center">
            <img 
              src="/logo.jpg" 
          ...
          <div className="flex flex-col">
            <span className="font-heading text-base md:text-lg font-bold text-slate-900 tracking-wider leading-none">
              KADAL TO KADAI
            </span>
            <span className="text-[9px] md:text-[10px] font-bold text-sky-600 tracking-widest leading-none mt-1">
        ...
        <nav className="hidden lg:flex items-center gap-2">
          {navItems.map((item) => (
            ...
            >
              {item.label}
              {item.active && (
                <span className="absolute bottom-1 left-1/2 -translate-x-1/2 w-1.5 h-1.5 rounded-full bg-[#0077b6]" />
              )}
            </Link>
          ))}
        </nav>
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            ...
            className="hidden md:flex items-center gap-2 text-sm text-slate-700 hover:text-slate-900 bg-slate-50 hover:bg-slate-100 px-4 py-2 rounded-full border border-slate-200 transition-all font-semibold"
          >
